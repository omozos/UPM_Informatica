...
- Escribir en una cadena :: =sprintf=
...
** Escribir en una cadena :: =sprintf=
- Igual que =printf= pero escribimos en una cadena destino
...
{
  char nombre[] = "Pepe";
  char apellido[] = "Sanchez";
  int edad = 35;	
  char todo[100]={'\0'};	

  sprintf(todo, "%s %s tiene %d años", nombre, apellido, edad); 	
